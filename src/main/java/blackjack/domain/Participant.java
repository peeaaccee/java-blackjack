...
public class Participant {
    private static final String INVALID_PARTICIPANT_NAME = "플리어 이름은 양쪽 공백을 제외한 1글자 이상이어야 합니다.";
    ...
    public abstract boolean isAbleToReceiveCasrd();
    ...
    public int calculateScoreWhenAceUsMinimum() {
